...
class _MainShellState extends State<MainShell> {
  ...
  Widget _buildSidebar(ThemeData theme) {
    ...
    return Container(
      width: 260,
      color: isDark ? const Color(0xFF020617) : const Color(0xFFF1F5F9), // Slate 100 in light mode
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Icon(Icons.terminal, color: isDark ? Colors.white38 : const Color(0xFF94A3B8), size: 14),
                ...
                Row(
                  ...
                  children: [
                    Text("Target:", style: TextStyle(color: isDark ? Colors.white70 : const Color(0xFF475569), fontSize: 11)),
                    Container(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(12),
            border: isSelected ? Border.all(color: theme.colorScheme.primary.withOpacity(0.3)) : Border.all(color: Colors.transparent),
          ),
          child: Row(
            children: [
              Icon(
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.description_outlined, color: isDark ? Colors.white38 : const Color(0xFF94A3B8), size: 18),
          ...
          Row(
            children: [
              IconButton(
                ...
                icon: Obx(() => Icon(
                  controller.themeMode.value == ThemeMode.dark ? Icons.light_mode_outlined : Icons.dark_mode_outlined,
                  color: isDark ? Colors.white70 : const Color(0xFF475569),
                )),
                ...
                onPressed: () {
                  Get.dialog(
                    AlertDialog(
                      ...
                      title: Text("Reset to Default", style: TextStyle(color: theme.colorScheme.onSurface)),
                      content: Text(
